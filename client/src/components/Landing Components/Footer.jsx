    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-column company">
          ...
          <p>
            Advancing sustainable stewardship across the Indian industrial
            landscape through innovation and ethical governance.
          </p>
        ...
        <div className="footer-column newsletter">
          ...
          <p>Stay updated on the latest ESG regulations and insights.</p>
      ...
      <div className="footer-bottom">
        <p>© 2024 India ESG Alliance. All rights reserved.</p>
