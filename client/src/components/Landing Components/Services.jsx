      ...
      >
        ...
        <div className="esg-header">
          <div>
            ...
            <p>Comprehensive ecosystem guide from awareness to compliance.</p>
          </div>

          <Link to="/solutions" className="view-btn">
        ...
        <div className="esg-grid">
          ...
          <div className="featured-card glass">
            ...
            <div className="card-image">
              <img src={screen} alt="Training" />
            </div>

            <div className="featured-content">
              <span className="badge">Capacity Building</span>

              <h3>ESG Training & Certifications</h3>

              <p>
                Expert-led modules for MSMEs to implement sustainable practices
                effectively.
              </p>
          ...
          <div className="right-grid">
            ...
            <div className="small-cards">
              <div className="small-card glass">
                ...
                <p>Matching compliant suppliers with procurement leads.</p>
              </div>
              ...
              <div className="small-card glass">
                ...
                <p>Access policy whitepapers and compliance checklists.</p>
              </div>
            </div>
          </div>
        </div>
